...
![image](https://github.com/user-attachments/assets/3d90656c-7a0b-40cd-9061-10b93fd8b713)
```cpp
static void threshMat(Mat& image)
	{
		Mat dst;
...
```
![image](https://github.com/user-attachments/assets/a6431263-faa0-42e2-b497-59df655f6bb8)
